...
/// <summary>
/// Static help text content matching the React frontend's helpContent.js.
/// </summary>
public static class HelpContent
{
    public static readonly Dictionary<string, HelpEntry> Entries = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["settings.connectors.azure-devops"] = new(
        ...
        ["settings.connectors.trello"] = new(
            "Setting up Trello",
            [
        ...
        ["settings.connectors.github"] = new(
        ...
        ["settings.connectors.microsoft-tasks"] = new(
            "Setting up Microsoft Tasks",
            [
        ...
        ["settings.connectors.outlook-flagged-mail"] = new(
            "Setting up Outlook Flagged Mail",
            [
